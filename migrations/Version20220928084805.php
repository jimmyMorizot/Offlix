 ...
 */
final class Version20220928084805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE release_date realease_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE realease_date release_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\'');
    }
}
