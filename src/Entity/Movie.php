...
class Movie
{
     ...
     * @Groups({"api_movies_get_collection", "api_movies_get_item"})
     */
    private $id;
    ...
    public function getLinkAllocine(): ?string
    {
        return $this->link_allocine;
    }

    public function setLinkAllocine(?string $link_allocine): self
    {
