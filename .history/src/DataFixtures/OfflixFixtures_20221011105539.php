...
{
    /** @var SluggerInterface $mySlugger le service Slugger */
    private $mySlugger;

    public function __construct(SluggerInterface $mySlugger)
    {
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $populator->addEntity(Movie::class, 6, [
            ...
            'poster' => function () {
                return "https://picsum.photos/id/".mt_rand(900, 1100)."/200/300";
            },
        ], [
            // on demande à récupérer le film courant (celui en cours de création par le populator)
            'slug' => function ($movie) {
