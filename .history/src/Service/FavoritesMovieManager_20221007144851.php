...
class FavoritesMovieManager
{
     ...
     */
    public function __construct(RequestStack $requestStack, bool $maxItems)
    {
     ...
     * 
     * @return @bool false, si le max est atteint, true sinon
     */
    public function addToFavorites(Movie $movie)
    {
        ...
        // TOP 5
        if (count($favorites) === $this->maxItems) {
            return false;
        }
     ...
     * 
     * @return bool Film supprimé ou non
     */
    ...
    {
        // on supprime l'attribut de session qui contient les favoris
