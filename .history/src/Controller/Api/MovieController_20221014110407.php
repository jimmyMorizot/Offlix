...
class MovieController extends AbstractController
{
     ...
     */
    public function postItem(Request $request, SerializerInterface $serializer, ManagerRegistry $doctrine )
    {
        // on récupère le contentu JSON
        ...
        // bonus réponse : on renvoie aussi la connée crée ( pas demandé par REST)
        return $this->json(
            $movie,
            Response::HTTP_CREATED,['Location' => $this->generateUrl('api_movies_get_item'), ['id' => $movie]],[
                'groups' => 'api_movies_get_item'
            ]
        );
