...
class MovieController extends AbstractController
{
    ...
    /**
     * Update Item (PATCH, modification partielle d'une entité/)
     * 
     * @Route("/api/movies/{id}", name="app_api_movies_patch_item", methods={"PATCH"})
     * 
     */
    public function patchItem (Movie $movie, Request $request, SerializerInterface $serializer,ManagerRegistry $doctrine, ValidatorInterface $validator) {
