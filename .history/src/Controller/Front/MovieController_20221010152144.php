...
class MovieController extends AbstractController
{
     ...
     * 
     * @Route("/movie/{slug}-{id<[0-9]+>}", name="movie_show", requirements={"id"="\d+"})
     */
    public function show(Movie $movie = null, ManagerRegistry $doctrine, MySlugger $lugger, string $slug): Response
    {
