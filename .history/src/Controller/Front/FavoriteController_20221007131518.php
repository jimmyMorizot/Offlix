...
class FavoriteController extends AbstractController
{
     ...
     */
    public function list(RequestStack $requestStack, FavoritesMovieManager $favoritesMovieManager): Response
    {
        $session = $requestStack->getSession();
        $favorites = $session->get('favorites');
        // $session->remove('favorites');

        $favoritesMovieManager->getFavorites();
     ...
     */
    public function add(int $id, RequestStack $requestStack,Movie $movie): Response
    {
